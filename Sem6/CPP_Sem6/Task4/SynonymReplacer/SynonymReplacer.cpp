...
// SynonymReplacer.cpp: определяет поведение классов для приложения.
//

#include "pch.h"
#include "resource.h"
#include "framework.h"
#include "SynonymReplacer.h"
...
BEGIN_MESSAGE_MAP(CSynonymReplacerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSynonymReplacerApp

CSynonymReplacerApp::CSynonymReplacerApp()
{
...
// Единственный объект CSynonymReplacerApp

CSynonymReplacerApp theApp;


// Инициализация CSynonymReplacerApp

BOOL CSynonymReplacerApp::InitInstance()
{
