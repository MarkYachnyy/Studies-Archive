...
public class ArrayUtils {
    ...
    */
    ...
    public static <T> T readFromConsole(String name, java.ru.cs.vsu.yachnyy_m_a.util.function.Function<String, T> converter) {
        Scanner scanner = new Scanner(System.in);
        while (true) {
            try {
    ...
    private static <T> T readArrayFromConsole(String arrName, java.ru.cs.vsu.yachnyy_m_a.util.function.Function<String, T> strToArrConverter) {
